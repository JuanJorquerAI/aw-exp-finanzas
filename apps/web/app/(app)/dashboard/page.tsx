  ...
  return (
    <div className="space-y-5 p-8">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-widest dark:text-slate-500 text-slate-400 mb-0.5">
            Resumen mensual
          </p>
          <h2 className="text-xl font-bold dark:text-slate-100 text-slate-900 first-letter:uppercase">
            {monthLabel(month)}
          </h2>
        </div>
