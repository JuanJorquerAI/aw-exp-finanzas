      ...
      <SheetContent className="dark:bg-slate-950 dark:border-slate-800 bg-white w-[400px] sm:w-[420px]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="space-y-1.5">
            <Label
              htmlFor="nt-company"
              className="dark:text-slate-400 text-slate-600 text-xs uppercase tracking-wider"
            >
              Empresa
            </Label>
            <select
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label className="dark:text-slate-400 text-slate-600 text-xs uppercase tracking-wider">
                Fecha
              </Label>
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              value={form.docType}
              onChange={(e) =>
                set("docType", e.target.value as TransactionDocType)
              }
              className={SELECT_CLS}
            >
          ...
          {form.docType !== "BOLETA_HONORARIOS" && (
            <div className="flex items-center justify-between rounded-md dark:bg-slate-900 bg-slate-50 border dark:border-slate-700 border-slate-200 px-3 py-2.5">
              ...
              >
                <span
                  className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${form.isAfecta ? "translate-x-4.5" : "translate-x-0.5"}`}
                />
              </button>
            </div>
          )}
